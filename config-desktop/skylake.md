...
<table><thead><tr><th width="252">AAPL,ig-platform-id</th><th>Comment</th></tr></thead><tbody><tr><td><strong><code>00001219</code></strong></td><td>Sử dụng khi igpu dùng để xuất hình</td></tr><tr><td><strong><code>01001219</code></strong></td><td>Sử dụng khi igpu không dùng để xuất hình mà dùng để tính toán</td></tr></tbody></table>

> Nếu bạn đang dùng `HD P530` loại này không được apple chính thức support. Nên bạn cần phải fake `device-id`&#x20;
...
| SMBIOS   | Hardware           |
| -------- | ------------------ |
| iMac17,1 | Monterey và cũ hơn |
| iMac18,1 | Ventura và mới hơn |
