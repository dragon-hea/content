...
* Note: IGPU các bạn sẽ phải tham khảo bài patch GMA IGPU [tại đây](https://app.gitbook.com/s/WaDTVx2hJ0rjBEHrlRj9/connector/patch-gma-gpu)
...
| Legacy                                                                                        | UEFI                                                                                              |
| --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| ![](https://dortania.github.io/OpenCore-Install-Guide/assets/img/booter-duetpkg.5a27db69.png) | ![](https://dortania.github.io/OpenCore-Install-Guide/assets/img/aptio-iv-booter-sl.5e63b543.png) |
...
| ---------------------- | ------- | ------------------------------ |
| AvoidRuntimeDefrag     | No      | Bắt buộc trên bigsur           |
| EnableSafeModeSlide    | No      |                                |
| EnableWriteUnprotector | No      |                                |
| ProvideCustomSlide     | No      |                                |
| RebuildAppleMemoryMap  | Yes     | bắt buộc từ OS X 10.4 đến 10.6 |
| SetupVirtualMap        | No      |                                |
...
{% hint style="info" %}
Nếu bạn định chạy macos 10.14 và mới hơn thì sẽ cần smbios MacPro6,1. Tuy nhiên bạn sẽ cần [telemetrap.kext ](https://forums.macrumors.com/threads/mp3-1-others-sse-4-2-emulation-to-enable-amd-metal-driver.2206682/page-4?post=28447707#post-28447707) để giải quyết các vấn đề cài đặt
{% endhint %}
...
| Quirk                  | Enabled | Comment                             |
| ---------------------- | ------- | ----------------------------------- |
| IgnoreInvalidFlexRatio | NO      | Enable nếu hệ thống của bạn là UEFI |
