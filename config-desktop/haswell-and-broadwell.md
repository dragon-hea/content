...
* Macos cao nhất:
  * Bản mới nhất
* Note: IGPU Haswell được support chính thức từ macos 12.0 trở xuống
...
<table><thead><tr><th width="252">AAPL,ig-platform-id</th><th>Comment</th></tr></thead><tbody><tr><td><strong><code>0300220D</code></strong></td><td>Sử dụng khi igpu <code>Haswell</code> dùng để xuất hình</td></tr><tr><td><code>04001204</code></td><td>Sử dụng khi igpu không dùng để xuất hình mà dùng để tính toán</td></tr><tr><td><strong><code>07002216</code></strong></td><td>Sử dụng khi igpu <code>Broadwell</code> dùng để xuất hình</td></tr></tbody></table>

> Nếu bạn đang dùng `HD 4400` loại này không được apple chính thức support. Nên bạn cần phải fake `device-id`&#x20;

> Tối khuyến khích bạn fake `device-id` thành `12040000` - Đây là id của `HD 4600`
...
> Đây là ví dụ của Iris Pro 6200
...
| SMBIOS   | Hardware             |
| -------- | -------------------- |
| iMac14,4 | Haswell với chỉ iGPU |
| iMac15,1 | Haswell với dGPU     |
| iMac16,2 | Broadwell            |
...
| SMBIOS   | Hardware               |
| -------- | ---------------------- |
| iMac16,2 | Broadwell với chỉ iGPU |
| iMac17,1 | Broadwell với dGPU     |
